  ...
  String time;
    ...
    private void updateDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateDataActionPerformed
        ...
        if(leave_table.getSelectedRowCount() == 1){
            ...
            tblModel.setValueAt(Id,leave_table.getSelectedRow(), 0);
            tblModel.setValueAt(Name,leave_table.getSelectedRow(), 1);
            tblModel.setValueAt(Job,leave_table.getSelectedRow(), 2);
