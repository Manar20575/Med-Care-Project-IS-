...
public class company extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        compant_table = new javax.swing.JTable();
        ...
        compant_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        compant_table.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                compant_tableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(compant_table);
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(166, 166, 166)
                        .addComponent(add_deal, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(215, 215, 215)
                        .addComponent(update_data, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(215, 215, 215)
                        .addComponent(delet_data, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//        }
        if(companyname_input.getText().equals("") || companyphone_input.getText().equals("") || companyaddress_input.getText().equals("") || med_name_input.getText().equals("") || med_amount_input.getText().equals("")){
            ...
            DefaultTableModel tblModel = (DefaultTableModel)compant_table.getModel();
    ...
    private void delet_dataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delet_dataActionPerformed
        // TODO add your handling code here:
        DefaultTableModel tblModel = (DefaultTableModel)compant_table.getModel();
        if(compant_table.getSelectedRowCount() == 1){
            //if single row selected
            tblModel.removeRow(compant_table.getSelectedRow());
        }
        else{
            //if row empty
            if(compant_table.getRowCount()==0){
    ...
    private void update_dataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_dataActionPerformed
        ...
        if(compant_table.getSelectedRowCount() == 1){
            // if row selected
            String Name = companyname_input.getText();
            String Phone = companyphone_input.getText();
            String Address = companyaddress_input.getText();
            String MedName = med_name_input.getText();
            String Medamount =  med_amount_input.getText();
            //set to uptade value in row 
            tblModel.setValueAt(Phone,compant_table.getSelectedRow(), 1);
            tblModel.setValueAt(Name,compant_table.getSelectedRow(), 0);
            tblModel.setValueAt(Address,compant_table.getSelectedRow(), 2);
            tblModel.setValueAt(MedName,compant_table.getSelectedRow(), 3);
            tblModel.setValueAt(Medamount,compant_table.getSelectedRow(), 4);
    ...
    private void compant_tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_compant_tableMouseClicked
        // TODO add your handling code here:
        DefaultTableModel tblModel = (DefaultTableModel)compant_table.getModel();

        String tblPhone =  tblModel.getValueAt(compant_table.getSelectedRow(),1).toString();
        String tblName =  tblModel.getValueAt(compant_table.getSelectedRow(),0).toString();
        String tblAddress =  tblModel.getValueAt(compant_table.getSelectedRow(),2).toString();
        String tblMedName =  tblModel.getValueAt(compant_table.getSelectedRow(),3).toString();
        String tblMedAmount =  tblModel.getValueAt(compant_table.getSelectedRow(),4).toString();
        companyname_input.setText(tblName);
        companyphone_input.setText(tblPhone);
        companyaddress_input.setText(tblAddress);
        med_name_input.setText(tblMedName);
        med_name_input.setText(tblMedAmount);
    }//GEN-LAST:event_compant_tableMouseClicked
    ...
    private javax.swing.JTable compant_table;
